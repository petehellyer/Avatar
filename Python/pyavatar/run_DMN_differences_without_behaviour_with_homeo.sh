...
output_with_DMN_path=../Output/simulation/without_behaviour/with_homeostasis/ddw_ws_corr/with_DMN
output_without_DMN_path=../Output/simulation/without_behaviour/with_homeostasis/ddw_ws_corr/without_DMN
logs_with_DMN_path=../logs/simulation/without_behaviour/with_homeostasis/ddw_ws_corr/with_DMN
logs_without_DMN_path=../logs/simulation/without_behaviour/with_homeostasis/ddw_ws_corr/without_DMN
