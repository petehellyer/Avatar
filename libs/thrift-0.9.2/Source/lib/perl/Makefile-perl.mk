# This Makefile is for the Thrift extension to perl.
#
...
#
#   MakeMaker ARGV: (q[MAKEFILE=Makefile-perl.mk], q[INSTALLDIRS=vendor], q[INSTALL_BASE=/usr/local])
#

#   MakeMaker Parameters:

#     AUTHOR => [q[Apache Thrift <dev@thrift.apache.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Thrift]
#     PREREQ_PM => { Bit::Vector=>q[0], Class::Accessor=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Thrift.pm]
...
LIBPERL_A = libperl.a
FIRST_MAKEFILE = Makefile-perl.mk
MAKEFILE_OLD = Makefile-perl.mk.old
MAKE_APERL_FILE = Makefile-perl.mk.aperl
PERLMAINCC = $(CC)
...
PM_TO_BLIB = lib/Thrift/Transport.pm \
	blib/lib/Thrift/Transport.pm \
	lib/Thrift/HttpClient.pm \
	blib/lib/Thrift/HttpClient.pm \
	lib/Thrift/FramedTransport.pm \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Apache Thrift <dev@thrift.apache.org>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Thrift' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'version: v0.9.2' >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) '{' > META_new.json
	$(NOECHO) $(ECHO) '   "abstract" : "unknown",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Apache Thrift <dev@thrift.apache.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Thrift",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   "version" : "v0.9.2"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
disttest : distdir
	cd $(DISTVNAME) && $(ABSPERLRUN) Makefile.PL "MAKEFILE=Makefile-perl.mk" "INSTALLDIRS=vendor" "INSTALL_BASE=/usr/local"
...
$(FIRST_MAKEFILE) : Makefile.PL $(CONFIGDEP)
	...
	$(PERLRUN) Makefile.PL "MAKEFILE=Makefile-perl.mk" "INSTALLDIRS=vendor" "INSTALL_BASE=/usr/local"
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Apache Thrift &lt;dev@thrift.apache.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Thrift/Transport.pm blib/lib/Thrift/Transport.pm \
	  lib/Thrift/HttpClient.pm blib/lib/Thrift/HttpClient.pm \
	  lib/Thrift/FramedTransport.pm blib/lib/Thrift/FramedTransport.pm \
	  lib/Thrift/BinaryProtocol.pm blib/lib/Thrift/BinaryProtocol.pm \
	  lib/Thrift/Socket.pm blib/lib/Thrift/Socket.pm \
	  lib/Thrift/Protocol.pm blib/lib/Thrift/Protocol.pm \
	  lib/Thrift/Server.pm blib/lib/Thrift/Server.pm \
	  lib/Thrift/MemoryBuffer.pm blib/lib/Thrift/MemoryBuffer.pm \
	  lib/Thrift.pm blib/lib/Thrift.pm \
	  lib/Thrift/BufferedTransport.pm blib/lib/Thrift/BufferedTransport.pm 
